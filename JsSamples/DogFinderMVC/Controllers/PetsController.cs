...
using DogFinderMVC.DAL;
using DogFinderMVC.Models;

namespace DogFinderMVC.Controllers
{
    public class PetsController : Controller
    {
        private PetFinderContext db = new PetFinderContext();
        ...
        //to bind well is necesary a constructor in viewmodel and public setters
        // POST: Pets/Create
